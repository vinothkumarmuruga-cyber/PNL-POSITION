...
with st.expander("📋 Exit Decision Calculator — calculate your R:R before entering a trade", expanded=False):
    st.caption(
        ...
        "before you actually place the trade."
    )

    decision_rows = load_decision_rows()

    st.markdown("**➕ Add Decision Row**")
    ...
    if decision_rows:
        ...
        st.markdown("**✏️ Edit / Delete Decision Row**")
